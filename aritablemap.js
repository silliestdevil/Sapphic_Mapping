...
const map = new mapboxgl.Map({
    ...
    center: [-0.127758, 51.507351], // starting position [lng, lat]
...
// Assuming markers, map, and filteredRecords are declared and initialized elsewhere
...
function addMarkers(records) {
    ...
    records.forEach(coord => {
        if (!isNaN(coord.Latitude) && !isNaN(coord.Longitude)) {
            ...
            if (eventType === "Sport") {
                markerColor = "rgb(218, 215,205)"; // Example color for Sport
            } else if (eventType === "Theatre") {
                markerColor = "rgb(58,90,64)"; // Example color for Theatre
            } else if (eventType === "Social") {
                markerColor = "rgb(	92, 129, 87)"; // Example color for Social
            } else if (eventType === "Club Night") {
                markerColor = "rgb(163,177,138)"; // Example color for Club Night
            } else if (eventType === "Bar") {
                markerColor = "rgb(	82, 121, 111)"; // Example color for Bar
            } else {
